...
@include_once( AROOT . 'lib' . DS . 'PHPExcel.php');
@include_once( AROOT . 'lib' . DS . 'PHPExcel' . DS . 'IOFactory.php');
...
include_once(AROOT . 'common' . DS . 'function.php');
